...
<svg width="813" height="709" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    ...
    <g clip-path="url(#clip1)" transform="translate(-120 -97)">
        ...
        <text class="label" transform="matrix(1 0 0 1 584.619 639)">粉丝</text>
        <text class="label" transform="matrix(1 0 0 1 584.619 721)">获赞</text>
        <text class="stat" transform="matrix(1 0 0 1 678.235 555)">${formatNum(data.following)}</text>
        <text class="stat" transform="matrix(1 0 0 1 678.235 637)">${formatNum(data.follower)}</text>
        <text class="stat" transform="matrix(1 0 0 1 678.235 718)">${formatNum(data.like)}</text>
