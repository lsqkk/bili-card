...
<svg width="813" height="709" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    ...
    <g clip-path="url(#clip1)" transform="translate(-120 -97)">
        ...
        <text class="signature" transform="matrix(1 0 0 1 195.309 659)">${signatureLines[0]}</text>
        <text class="signature" transform="matrix(1 0 0 1 195.309 681)">${signatureLines[1]}</text>
        <text class="signature" transform="matrix(1 0 0 1 195.309 703)">${signatureLines[2]}</text>
