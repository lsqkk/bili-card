...
<svg width="1945" height="894" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    ...
    <g transform="translate(2 2)">
        ...
        <text fill="${palette.textColor}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="46" transform="matrix(1 0 0 1 103.121 766)">关注</text>
        <text fill="${palette.textColor}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="46" transform="matrix(1 0 0 1 354.763 766)">粉丝</text>
        <text fill="${palette.textColor}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="46" transform="matrix(1 0 0 1 750.283 766)">获赞</text>
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 93.955 683)">${formatNum(data.following)}</text>
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 345.597 683)">${formatNum(data.follower)}</text>
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 741.117 683)">${formatNum(data.like)}</text>
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="50" transform="matrix(1 0 0 1 463.607 290)">${signatureLines[0]}</text>
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="50" transform="matrix(1 0 0 1 463.607 381)">${signatureLines[1]}</text>
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="50" transform="matrix(1 0 0 1 463.607 472)">${signatureLines[2]}</text>
        ...
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="46" transform="matrix(1 0 0 1 1138.44 573)">${videoTitleLines[0]}</text>
        <text fill="${palette.textColor2}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="46" transform="matrix(1 0 0 1 1138.44 628)">${videoTitleLines[1]}</text>
        ` : ''}
        
        <text fill="${palette.textColor}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="73" transform="matrix(1 0 0 1 1553.46 729)">最新视频</text>
