...
<svg width="1945" height="894" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    ...
    <g transform="translate(2 2)">
        ...
        <text font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 93.955 683)">${formatNum(data.following)}</text>
        <text font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 345.597 683)">${formatNum(data.follower)}</text>
        <text font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 741.117 683)">${formatNum(data.like)}</text>
        ...
        <g transform="translate(290 420)">
            ${data.level >= 0 && data.level <= 6 ? `
                <image 
                    ...
                    width="100" 
                    height="50" 
                    xlink:href="https://cdn.jsdelivr.net/gh/lsqkk/bili-card/assets/LV${data.level}${data.level === 6 ? '_Lightning' : ''}.svg"
