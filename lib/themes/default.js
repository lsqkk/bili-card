...
<svg width="1945" height="894" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    ...
    <g transform="translate(2 2)">
        ...
        <text fill="${palette.textColor}" font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="400" font-size="46" transform="matrix(1 0 0 1 404.763 766)">粉丝</text>
        ...
        <text font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 395.597 683)">${formatNum(data.follower)}</text>
