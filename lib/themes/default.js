...
const generateSVG = (data, palette) => {
    ...
    return `
<svg width="1945" height="894" viewBox="0 0 1945 894" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    <defs>
        <style type="text/css">
            ${styleString}
        </style>
        ...
        <image width="465" height="465" href="${data.face}" xlink:href="${data.face}" preserveAspectRatio="none" id="img4"></image>
        <clipPath id="clip5">
        ...
        <image width="1017" height="572" href="${data.video ? data.video.cover : ''}" xlink:href="${data.video ? data.video.cover : ''}" preserveAspectRatio="none" id="img8"></image>
        <clipPath id="clip9">
    ...
    <g transform="translate(2 2)">
        ...
        <g clip-path="url(#clip5)">
            <use width="100%" height="100%" href="#img4" xlink:href="#img4" transform="matrix(0.698925 0 0 0.698924 74.9999 123)">
            </use>
        </g>
        ...
        <text class="label" transform="matrix(1 0 0 1 365 766)">粉丝</text>
        ...
        <text class="stat" transform="matrix(1 0 0 1 356 683)">${formatNum(data.follower)}</text>
        <text class="stat" transform="matrix(1 0 0 1 741.117 683)">${formatNum(data.like)}</text>
        ${renderTextLines(signatureLines, 'signature', 463.607, 290, 91)}
        
        <g transform="translate(300 410) scale(2)">
        ...
        <g filter="url(#fx1)" transform="translate(1124 54)">
            <g>
                <g clip-path="url(#clip7)">
                    <use width="100%" height="100%" href="#img8" xlink:href="#img8" transform="matrix(0.73353 0 0 0.732518 19.7228 19.7227)"></use>
                </g>
            </g>
        </g>
        <g clip-path="url(#clip9)">
            <use width="100%" height="100%" href="#img8" xlink:href="#img8" transform="matrix(0.73353 0 0 0.732518 1134 63.9999)">
            </use>
        </g>
        ${renderTextLines(videoTitleLines, 'video-title', 1138.44, 573, 55)}
        ` : data.video?.error ? `
        <text class="video-title" fill="${palette.textColor2}" opacity="0.5" transform="matrix(1 0 0 1 1138.44 573)">视频数据加载失败</text>
        ` : ''}
        
        ${data.video ? `<text class="video-label" transform="matrix(1 0 0 1 1553.46 729)">最新视频</text>` : ''}
        ${generateFooter(1558.33, 822, 'footer', palette.accentColor, 37)}
    </g>
</svg>
  `;
};
