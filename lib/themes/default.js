// lib/themes/blue.js - 蓝色主题（基于1.html模板）
const generateSVG = (data, theme = 'light') => {
  ...
  // 获取用户统计数据（这里需要额外API调用获取获赞数，暂时使用占位符）
  // 注意：原API没有返回获赞数，这里需要额外获取或修改逻辑
  const likeCount = 0; // 需要从API获取
...
<svg width="1945" height="894" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    ...
    <g transform="translate(2 2)">
        ...
        <text font-family="Microsoft YaHei,Microsoft YaHei_MSFontService,sans-serif" font-weight="700" font-size="83" transform="matrix(1 0 0 1 791.117 683)">${formatNum(data.likes)}</text>
