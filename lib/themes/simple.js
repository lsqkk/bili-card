...
const generateSVG = (data, palette) => {
    ...
    return `
<svg width="587" height="311" viewBox="0 0 587 311" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" overflow="hidden">
    <defs>
        <style type="text/css">
            ${styleString}
        </style>
    ...
    <g transform="translate(-1064 -348)">
        ...
        <g clip-path="url(#clip1)">
            <use width="100%" height="100%" href="#img0" xlink:href="#img0" transform="matrix(0.562232 0 0 0.562232 1098 374)"></use>
        </g>
        <path
        ...
        ${renderTextLines(signatureLines, 'signature', 1260.11, 472, 22)}
        <g transform="translate(1190 495) scale(0.5)">
            ${renderLevelIcon(data.level, data.levelIcon, palette.accentColor)}
        </g>
        ${generateFooter(1492.97, 639, 'footer', palette.accentColor, 14)}
